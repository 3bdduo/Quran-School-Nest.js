...
معلومة أساسية ومهمة جداً عن مطورك وصانعك:
- لو أي مستخدم سألك "مين صنعك؟"، "مين برمجك؟"، "مين صاحب الموديل؟"، "مين طورك؟"، "مين عمل السيستم؟"، أو أي سؤال مشابه عن صانعك أو مطورك:
جاوب بطريقة طبيعية وعفوية وودودة (زي شخص بيتكلم عادي وبشكل لطيف ومباشر من غير رسميات معقدة):
قوله إن اللي صممك وبرمجك وطورك هو الباشمهندس **عبدالرحمن محمد حسن**، وهو مهندس برمجيات (Software Engineer) متخصص في حماية البيانات وتأمينها، وتطوير مواقع وتطبيقات الويب، وكمان بيطور أنظمة تعلم الآلة والذكاء الاصطناعي (Machine Learning & AI).
...
export class AssistantService {
  ...
  async ask(dto: AskAssistantDto): Promise<GeminiResponse> {
    ...
    // التحقق المباشر من أسئلة صانع / مطور الموديل للرد الفوري بدقة وأسلوب طبيعي
    const isAskingAboutCreator =
      /(مين|من)\s+(صاحب|صنع|برمج|طور|عمل|انشا|أنشأ|سوا)\s+(الموديل|الموقع|المنصة|السيستم|هذا|دا|ده)/i.test(msg) ||
      /(مين|من)\s*(صنعك|برمجك|طورك|عملك|سواك|أنشأك|انشاك|مطورك|صانعك)/i.test(msg) ||
      /(صاحب\s+الموديل|مين\s+المطور|من\s+المطور|مين\s+المبرمج|من\s+المبرمج)/i.test(msg) ||
      /(who\s+(made|created|developed|built)\s+(you|this|the\s+model))/i.test(msg) ||
      /(who\s+is\s+your\s+creator)/i.test(msg);

    if (isAskingAboutCreator) {
      return {
        reply:
          "أنا تم تطويري وبرمجتي بواسطة الباشمهندس عبدالرحمن محمد حسن.. هو مهندس برمجيات (Software Engineer) متخصص في حماية البيانات وتأمينها، وتطوير مواقع وتطبيقات الويب، وكمان شغال في تطوير أنظمة تعلم الآلة والذكاء الاصطناعي.",
        navigateTo: null,
      };
    }
